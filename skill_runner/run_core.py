...
def _build_agent(
    ...
    capabilities: list[Any] = [
        ...
        CodeMode(
            ...
            mount=[
                MountDir(host_path=str(context.ws_path), virtual_path=SANDBOX_WORKSPACE_MOUNT, mode="read-write"),
                MountDir(host_path=str(context.skill_path.resolve()), virtual_path=SANDBOX_SKILL_MOUNT, mode="read-only"),
                MountDir(host_path=str(context.source_root), virtual_path=SANDBOX_DATA_SOURCE_MOUNT, mode="read-only"),
                MountDir(host_path=str(context.source_root), virtual_path=SANDBOX_DATA_MOUNT, mode="read-only"),
            ],
